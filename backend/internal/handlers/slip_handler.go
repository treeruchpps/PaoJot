...
รูปแบบ:
{
  "bank": "ชื่อธนาคารหรือแพลตฟอร์ม เช่น กสิกรไทย ไทยพาณิชย์ กรุงเทพ กรุงไทย ออมสิน กรุงศรี ทีทีบี ธ.ก.ส. UOB G-Wallet ถุงเงิน เป๋าตัง",
  "amount": 0.00,
  "date": "YYYY-MM-DD",
  "time": "HH:MM",
...
- amount: เป็น float ไม่มี comma เช่น 1500.00
  ...
  - สำหรับ G-Wallet / คนละครึ่ง: "ค่าสินค้า/บริการ" คือราคาเต็ม ให้ใช้ "จำนวนเงินที่ชำระ" แทน
...
- bank: ถ้าเป็น G-Wallet หรือ ถุงเงิน ให้ใส่ "G-Wallet" ถ้าเป็น เป๋าตัง ให้ใส่ "เป๋าตัง"`
