...
-- ตาราง chat_logs (ประวัติแชทผู้ช่วยบันทึกเร็ว แยกตามผู้ใช้และโหมด)
...
CREATE INDEX idx_chat_logs_user  ON chat_logs(user_id, mode);
...
CREATE TRIGGER trg_chat_logs_updated_at
